...
describe('#shouldBuyCar()', function() {
  ...
  it("should return false when the car has 6 litres/100km and is over to $5,000", function() {
    const car = {
      litresPer100km: 6,
      price: 5001
    };
  ...
  it("should return false when the car has 11 litres/100km and is under or equal to $5,000", function() {
    const car = {
      litresPer100km: 12,
      price: 5000
    };
